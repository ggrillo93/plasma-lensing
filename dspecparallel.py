...
Parallel(n_jobs = ncpus)(delayed(fsliceGBulk)(*[upvec[i], freqcaus[i], fmin, fmax, leqinv, ax, ay, rx, ry, uvec, rF2p, lcp, coeff, cdist, nfpts, comp, num]) for i in range(len(upxvec)))
